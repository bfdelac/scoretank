...
<head>
        ...
        <?php if( strlen( $STtitle ) ) {
// Added by Bernard 26 Mar 2016
            echo( $STtitle );
              } else { ?>
          ...
          <div class="row-fluid">
              ...
              <div id="fav-header" class="span12 clearfix">
                ...
                <div id="fav-logo" class="span12">
                  ...
                  <?php if (($show_media_logo) !=0) : ?>
                    <h1>
<?php // Bernard 28 Mar 2016  <a class="media-logo" href="< ?php echo $this->baseurl; ? >/"> ?>
                        <img src="<?php echo $this->baseurl ?>/<?php echo htmlspecialchars($media_logo);?>" style="border:0;" alt="<?php echo htmlspecialchars($media_logo_img_alt);?>" />
                        <span class="header1">Free Community Sports Management</span>
<?php //                     </a> ?>
                    </h1>
                  <?php endif;?>
                  <?php if (($show_text_logo) !=0) : ?>
                    ...
                    <?php if (($show_copyright) !=0) : ?>
                      <div id="fav-showcopyright"
                        ...
                        elseif ( $copyright == 4 ):echo ('span3');
                          ...
                          <p>Copyright &#0169; 1998-<?php echo date('Y'); ?>
